...
class Planta(models.Model):
    ...
    viveros=models.ManyToManyField(Vivero, blank=True, null=True, help_text='<br> Mantenga CTRL para seleccionar varios')
    peligrosComunes=models.ManyToManyField(Problema, blank=True, null=True, help_text='<br> Mantenga CTRL para seleccionar varios')
